    ...
    <>
      <Paper sx={{ width: 280, p: 2 }}>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "Menos de $1").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$1,5 a $2").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$2,5 a $3").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$3,5 a $4").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$4,5 a $5").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$5,5 a $6").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$6 a $8").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$8 a $10").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$10 a $12,5").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$12,5 a $15").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$15 a $18").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "$18 a $21").length}
              color="success"
            />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <Chip
              label={wageCount.filter((obj) => obj === "Más de $21").length}
              color="success"
            />
          </Grid>
        </Grid>
